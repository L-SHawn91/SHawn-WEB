...
The safety analysis set included all treated participants, but the deaths and serious adverse events must be interpreted in the context of an advanced cancer population with progressive disease after prior platinum-based chemotherapy and anti-PD-1 or PD-L1 therapy. The absence of dose-limiting toxicities across all four dose levels suggests a tolerable safety profile at the tested doses, though the immunogenicity signal with the observed anti-drug antibody signal warrants further investigation if development continues.
